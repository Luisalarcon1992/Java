...
public class Main {
    public static void main(String[] args) {
        ...
        Estudiante estudiante1 = new Estudiante("Luis", "Alarcon", 1200);
        Estudiante estudiante2 = new Estudiante("Dionisio", "Alarcon", 1240);
        Estudiante estudiante3 = new Estudiante("Amilcar", "Alarcon", 1300);
